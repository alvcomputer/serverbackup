...
DROP TABLE IF EXISTS `wp_huge_it_catalog_asc_seller`;
...
LOCK TABLES `wp_huge_it_catalog_asc_seller` WRITE;
/*!40000 ALTER TABLE `wp_huge_it_catalog_asc_seller` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_huge_it_catalog_asc_seller` ENABLE KEYS */;
UNLOCK TABLES;
